...
<body>
    ...
    <!-- Service Section -->
    <div class="content">
        <h2 class="section-title">Our Security Services We Provide</h2>
        <div class="service-list">
            <div class="service-item">
                <h3>Surveillance Camera Installation</h3>
                <p>Install high-quality surveillance cameras for home and business security.</p>
                <p class="price">$300 - $800</p>
            </div>
            <div class="service-item">
                <h3>Alarm Systems</h3>
                <p>Secure your property with state-of-the-art alarm systems.</p>
                <p class="price">$200 - $600</p>
            </div>
            <div class="service-item">
                <h3>Access Control Systems</h3>
                <p>Ensure safety with professional access control system installations.</p>
                <p class="price">$400 - $1,000</p>
            </div>
        </div>
    </div>
        ...
        <div class="contact-form">
            <form action="process_form.php" method="POST">
                ...
                <select id="service" name="service" required>
                    ...
                    <option value="surveillance-camera">Surveillance Camera Installation</option>
