...
<body>
    ...
    <!-- Painting Services Banner -->
    <div class="banner">
        <img src="images/paintingservicesbanner.jpeg" alt="Painting Services Banner">
    </div>

    <!-- Service Section -->
    <div class="content">
        <h2 class="section-title">Our Painting Services We Provide</h2>
        <div class="service-list">
            <div class="service-item">
                <h3>Interior Painting</h3>
                <p>Professional painting services for your home's interiors, creating beautiful and vibrant spaces.</p>
                <p class="price">₹3000 - ₹8000</p>
            </div>
            <div class="service-item">
                <h3>Exterior Painting</h3>
                <p>Long-lasting exterior painting services to protect and enhance your property's appearance.</p>
                <p class="price">₹5000 - ₹12000</p>
            </div>
            <div class="service-item">
                <h3>Custom Painting</h3>
                <p>We provide custom painting solutions tailored to your specific preferences and needs.</p>
                <p class="price">₹4000 - ₹10000</p>
            </div>
        </div>
    </div>
