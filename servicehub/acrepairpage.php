...
<body>
    ...
    <!-- AC Repairing Services Banner -->
    <div class="banner">
        <img src="images/acrepairingservicesbanner.jpg" alt="AC Repairing Services Banner">
    </div>

    <!-- Service Section -->
    <div class="content">
        <h2 class="section-title">Our AC Repairing Services We Provide</h2>
        <div class="service-list">
            <div class="service-item">
                <h3>AC Installation</h3>
                <p>Professional air conditioner installation for homes and offices.</p>
                <p class="price">&#8377; 200 - &#8377; 500</p> <!-- Changed to INR -->
            </div>
            <div class="service-item">
                <h3>AC Maintenance</h3>
                <p>Regular maintenance to ensure your AC performs at its best.</p>
                <p class="price">&#8377; 100 - &#8377; 300</p> <!-- Changed to INR -->
            </div>
            <div class="service-item">
                <h3>AC Repairs</h3>
                <p>Expert troubleshooting and repair for all AC-related issues.</p>
                <p class="price">&#8377; 150 - &#8377; 400</p> <!-- Changed to INR -->
            </div>
        </div>
    </div>
