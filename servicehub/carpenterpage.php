...
<body>
    ...
    <!-- Service Section -->
    <div class="content">
        <h2 class="section-title">Our Carpenter Services We Provide</h2>
        <div class="service-list">
            <div class="service-item">
                <h3>Furniture Assembly</h3>
                <p>Expert furniture assembly services for your home or office.</p>
                <p class="price">₹7,500 - ₹22,500</p> <!-- Updated currency -->
            </div>
            <div class="service-item">
                <h3>Custom Woodwork</h3>
                <p>We specialize in custom woodwork to create unique furniture and designs.</p>
                <p class="price">₹15,000 - ₹60,000</p> <!-- Updated currency -->
            </div>
            <div class="service-item">
                <h3>Repairs & Maintenance</h3>
                <p>We provide repair and maintenance services for all your wooden furniture and fixtures.</p>
                <p class="price">₹3,750 - ₹18,750</p> <!-- Updated currency -->
            </div>
        </div>
    </div>
