...
<body>
    ...
    <!-- Service Section -->
    <div class="content">
        <h2 class="section-title">Our Electrical Services We Provide</h2>
        <div class="service-list">
            <div class="service-item">
                <h3>Wiring & Installation</h3>
                <p>We offer professional wiring and electrical installations for residential and commercial properties.</p>
                <p class="price">₹15,000 - ₹40,000</p>
            </div>
            <div class="service-item">
                <h3>Lighting Solutions</h3>
                <p>From custom lighting setups to energy-efficient LED installations, we handle all your lighting needs.</p>
                <p class="price">₹7,500 - ₹30,000</p>
            </div>
            <div class="service-item">
                <h3>Electrical Repairs</h3>
                <p>Need repairs for your electrical systems? Our team is skilled in troubleshooting and fixing any electrical issues.</p>
                <p class="price">₹6,000 - ₹20,000</p>
            </div>
        </div>
    </div>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($conn->query($sql) === TRUE) {
        ...
        header('Location: electricianpage.php');
        exit();
    } else {
