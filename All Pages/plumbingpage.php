...
<body>
    ...
    <!-- Plumber Banner -->
    <div class="banner">
        <img src="images/plumberservicesbanner.jpg" alt="Plumber Services Banner">
    </div>


    <!-- Service Section -->
    <div class="content">
        <h2 class="section-title">Our Plumbing Services We Provide</h2>
        <div class="service-list">
            <div class="service-item">
                <h3>Pipe Repairs</h3>
                <p>We offer professional pipe repairs for leaks, blockages, and damaged pipes in both residential and commercial properties.</p>
                <p class="price">$100 - $300</p>
            </div>
            <div class="service-item">
                <h3>Drain Cleaning</h3>
                <p>Our plumbers offer reliable drain cleaning services to clear blockages and restore proper water flow.</p>
                <p class="price">$80 - $250</p>
            </div>
            <div class="service-item">
                <h3>Water Heater Installation</h3>
                <p>We install and repair water heaters, providing both traditional and tankless solutions for hot water needs.</p>
                <p class="price">$200 - $600</p>
            </div>
        </div>
    </div>
