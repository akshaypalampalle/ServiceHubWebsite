...
<body>
    ...
    <!-- Service Section -->
    <div class="content">
        <h2 class="section-title">Our Cleaning Services We Provide</h2>
        <div class="service-list">
            <div class="service-item">
                <h3>Home Cleaning</h3>
                <p>Our expert cleaners provide detailed home cleaning services that include dusting, vacuuming, mopping, and more.</p>
                <p class="price">$100 - $300</p>
            </div>
            <div class="service-item">
                <h3>Office Cleaning</h3>
                <p>We offer professional office cleaning, ensuring a clean and healthy work environment for your employees and clients.</p>
                <p class="price">$150 - $500</p>
            </div>
            <div class="service-item">
                <h3>Deep Cleaning</h3>
                <p>Our deep cleaning service tackles every corner, offering a thorough clean for your home or office space.</p>
